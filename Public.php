...
if (!function_exists('modularity_pitea_hero_render_blade_view')) {
    function modularity_pitea_hero_render_blade_view($view, $data = [], $compress = true)
    {
        $init = new ComponentLibraryInit([
            MODULARITY_PITEA_HERO__MODULE_VIEW_PATH
        ]);
